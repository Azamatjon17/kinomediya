      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            right: 0,
            child: Container(
              decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.only(topLeft: Radius.circular(30), topRight: Radius.circular(30)), boxShadow: [BoxShadow(blurRadius: 200, spreadRadius: 10, color: Colors.grey.withOpacity(0.5))]),
              child: Row(
